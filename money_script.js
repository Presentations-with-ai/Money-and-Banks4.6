...
function hasChatGptGeneratedOptionsMark(question) {
  return Boolean(question && question.chatgptGeneratedOptions === true);
}

function getChatGptGeneratedOptionsNoteHtml(question) {
  if (!hasChatGptGeneratedOptionsMark(question)) return '';
  return '<div class="chatgpt-generated-note">Варианты сгенерированы с помощью ChatGPT</div>';
}
  ...
  container.innerHTML = visibleItems.map((entry) => {
    ...
    return `
      <div class="study-card">
        ...
        ${getChatGptGeneratedOptionsNoteHtml(item)}
...
function showQuestion() {
  ...
  qContainer.innerHTML = `
    ...
    ${getChatGptGeneratedOptionsNoteHtml(q)}
  `;
